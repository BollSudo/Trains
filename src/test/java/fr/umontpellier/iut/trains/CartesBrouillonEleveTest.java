...
public class CartesBrouillonEleveTest extends BaseTestClass {
    ...
    public void test_achat_carte_victoire(Carte c) {
        ...
        joueur.incrementerArgent(c.getCout());
    ...
    void test_calcul_fin() {
        ...
        for (int i = 0; i < 19; i++) {
            ...
            setAttribute(joueur, "nbJetonsRails", getNbJetonsRails(joueur)-1);
    ...
    void test_calcul_fin_toute_pioche() {
        ...
        for (int i = 0; i < 3; i++) {
            ((TuileVille) tuiles.get(8)).ajouterGare();
            setAttribute(jeu, "nbJetonsGare", jeu.getNbJetonsGare()-1);
        }
        for (int i = 0; i < 2; i++) {
            ((TuileVille) tuiles.get(11)).ajouterGare();
            setAttribute(jeu, "nbJetonsGare", jeu.getNbJetonsGare()-1);
        ...
        assertEquals(0, getPointsRails(joueur));
        assertEquals(0, getNbJetonsRails(joueur));
        assertEquals(34, joueur.calculerScoreRails()+
                joueur.calculerScoreCartes(defausse)+
                joueur.calculerScoreCartes(main)+
                joueur.calculerScoreCartes(pioche));
    }
